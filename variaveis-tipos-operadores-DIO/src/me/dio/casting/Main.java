...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        i2 = (int) l2;//Dowcast com perca

        int i3;
        long l3 = 10000L;
        i3 = (int) l3;//Dowcast sem perca
        ...
        float f3;
        double d2 = 10000.58d;
        f2 = (float) d2;//Downcast sem perca
        double d3 = 10000.588888888888888888888888888888888888888888888888888888888888888888888888888888888888d;
        f3 = (float) d3;//Downcast com perca

        int i4;
        float f4 = 11.5697f;
        i4 = (int) f4;//Truncar o valor, igora parte fracionada e transforma em inteiro
